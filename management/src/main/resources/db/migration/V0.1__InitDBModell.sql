...
(
    ...
    ID                      CHAR(36) NOT NULL,
    CATASTRALDOWNSHIPNUMBER BIGINT NOT NULL,
    ESTATEID                VARCHAR(100) NOT NULL,
    DEPOSITNUMBER           BIGINT NOT NULL,
    
    PRIMARY KEY (ID),
    UNIQUE (CATASTRALDOWNSHIPNUMBER, ESTATEID, DEPOSITNUMBER)
);
...
insert into REALESTATE (VERSION, ID, CATASTRALDOWNSHIPNUMBER, ESTATEID, DEPOSITNUMBER) 
