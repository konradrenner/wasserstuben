...
insert into REALESTATE (VERSION, ID, CADASTRALTOWNSHIP, ESTATEID, DEPOSTID) 
...
values (1, '5bef8aab-80d3-4b98-b3ce-dfcdf43ce6b1');

insert into COUNTERFITTING (VERSION, ID, CADASTRALTOWNSHIP, ESTATEID, DEPOSTID, DESCRIPTION, INSTALLATION, MANUFACTURER) 
values (1, '1964ae29-f2e1-4d70-a0b2-eb42a430e71b', 1, 'abcd', 2, 'test fitting', '2004-10-19 10:23:54', 'Super Mario');
