 ...
 * @author rpri182
 */
@AnalyzeClasses(packages = "org.kore.wg.entity", importOptions = {ImportOption.DoNotIncludeTests.class})
public class TechnologyFreeDomainTest {
    ...
    ArchRule domain_objects_must_use_plain_java_or_bean_validation = classes()
            ...
            .resideInAnyPackage("java..", "javax.validation..", "org.kore.wg.entity..");
}
